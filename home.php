  ...
  <div class="container text-container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h2 class="entry-title"><?php echo post_type_archive_title(); ?></h2>
        <?php
        ...
        <div class="archive__container">
          ...
          <div class="archive__item" itemscope itemtype="http://schema.org/Article">
            ...
            <div class="archive__item-text-wrapper">
              ...
              <a class="more-link archive__item-link" href="<?php echo get_permalink( $post->ID ); ?>"><?php  _e('Elolvasom', TEXTDOMAIN); ?></a>
            </div>
        ...
        <div class="clear"></div>
        <?php else: ?>
        <span class="archive__item-noresult"><strong><?php _e('Nincs megjeleníthető tartalom', TEXTDOMAIN); ?></strong></span>
        <?php endif; ?>
